define("ace/mode/css_highlight_rules",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/html_elixir_highlight_rules", "ace/mode/html",
        "ace/mode/javascript", "ace/mode/css", "ace/mode/elixir"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
        ...
        r.inherits(f, s), function() { this.$id = "ace/mode/html_elixir" }.call(f.prototype), t.Mode = f
    });
(function() {
    window.require(["ace/mode/html_elixir"],
        function(m) {
