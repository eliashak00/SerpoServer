define("ace/keyboard/vim",
    [
        "require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop",
        "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight",
        "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"
    ],
    function(e, t, n) {
        "use strict";
        ...
        function x(e) {
            e.setOption("disableInput", !0), e.setOption("showCursorWhenSelecting", !1), v.signal(e,
                "vim-mode-change",
                { mode: "normal" }), e.on("cursorActivity", Gn), tt(e), v.on(e.getInputField(), "paste", M(e))
        }

        function T(e) {
            e.setOption("disableInput", !1), e.off("cursorActivity", Gn), v.off(e.getInputField(), "paste", M(e)),
                e.state.vim = null
        }
        ...
        function Q(e, t, n, r) {
            ...
            i.callback
                ...
                : (s !== "local" && (i.value = i.type == "boolean" ? !!t : t), s !== "global" &&
                    n &&
                    (n.state.vim.options[e] = { value: t }))
        }
        ...
        function et() {
            this.latestRegister = undefined, this.isPlaying = !1, this.isRecording = !1, this.replaySearchQueries =
                [], this.onRecordingDone = undefined, this.lastInsertModeChanges = Z()
        }
        ...
        function ot() {
            this.prefixRepeat = [], this.motionRepeat = [], this.operator = null, this.operatorArgs =
                null, this.motion = null, this.motionArgs = null, this.keyBuffer = [], this.registerName = null
        }

        function ut(e, t) { e.state.vim.inputState = new ot, v.signal(e, "vim-command-done", t) }

        function at(e, t, n) {
            this.clear(), this.keyBuffer = [e || ""], this.insertModeChanges = [], this.searchQueries =
                [], this.linewise = !!t, this.blockwise = !!n
        }
        ...
        function lt(e) {
            this.registers = e, this.unnamedRegister = e['"'] = new at, e["."] = new at, e[":"] = new at, e["/"] =
                new at
        }

        function ct() { this.historyBuffer = [], this.iterator = 0, this.initialPrefix = null }
        ...
        function wt(e, t, n) {
            var r = Math.min(Math.max(e.firstLine(), t.line), e.lastLine()), i = Pt(e, r) - 1;
            i = n ? i + 1 : i;
        ...
        function Tt(e, t, n, r) {
            ...
            for (var u = 0; u < t.length; u++) {
                var a = t[u];
                if (n == "insert" && a.context != "insert" ||
                    a.context && a.context != n ||
                    r.operator && a.type == "action" ||
                    !(i = Nt(e, a.keys))) continue;
        ...
        function kt(e, t, n) { return function() { for (var r = 0; r < n; r++) t(e) } }
        ...
        function Mt(e, t) {
            return arguments.length > 2 && (t = Mt.apply(undefined, Array.prototype.slice.call(arguments, 1))), Ot(e, t)
                ? e
                : t
        }

        function _t(e, t) {
            return arguments.length > 2 && (t = _t.apply(undefined, Array.prototype.slice.call(arguments, 1))), Ot(e, t)
                ? t
                : e
        }

        function Dt(e, t, n) {
            var r = Ot(e, t), i = Ot(t, n);
            return r && i
        }
        ...
        function jt(e, t, n) {
            var r = Pt(e, t), i = (new Array(n - r + 1)).join(" ");
            ...
            var n = t.lastSelection,
                ...
                i = function() {
                    ...
                    if (i) {
                        ...
                        r = { line: r.line + d, ch: d ? r.ch : v + r.ch }, n.visualLine &&
                            (t = E(t.line, 0), r = E(r.line, Pt(e, r.line))), e.setSelection(t, r)
                    }
                    return[t, r]
                };
        ...
        function zt(e, t, n) {
            ...
            return Ot(n, t) && (o = n, n = t, t = o), Ot(i, s)
                ? (i = Mt(t, i), s = _t(s, n))
                : (s = Mt(t, s), i = _t(i, n), i =
                    St(i, 0, -1), i.ch == -1 && i.line != e.firstLine() && (i = E(i.line - 1, Pt(e, i.line - 1)))), [
                s, i
            ]
        }
        ...
        function Wt(e, t, n) {
            var r = e.state.vim;
            t = t || r.sel;
            var n = n || r.visualLine ? "line" : r.visualBlock ? "block" : "char", i = Xt(e, t, n);
            e.setSelections(i.ranges, i.primary), Yn(e)
        }

        function Xt(e, t, n, r) {
            var i = Lt(t.head), s = Lt(t.anchor);
            if (n == "char") {
        ...
        function $t(e, t) {
            var n = e.state.vim;
            t !== !1 && e.setCursor(wt(e, n.sel.head)), Ut(e, n), n.visualMode = !1, n.visualLine = !1, n.visualBlock =
                !1, v.signal(e, "vim-mode-change", { mode: "normal" }), n.fakeCursor && n.fakeCursor.clear()
        }
        ...
        function Gt(e, t, n, r, i) {
            var s = Vt(e), o = e.getLine(s.line), u = s.ch, a = i ? D[0] : P[0];
            while (!a(o.charAt(u))) {
                u++;
        ...
        function Zt(e, t) {
            nt.lastCharacterSearch.increment = e, nt.lastCharacterSearch.forward =
                t.forward, nt.lastCharacterSearch.selectedCharacter = t.selectedCharacter
        }
        ...
        function nn(e, t, n, r) {
            var i = Lt(e.getCursor()),
                ...
                c = en[r];
            if (!c) return i;
            var h = tn[c].init, p = tn[c].isComplete;
            h && h(l);
            while (a !== o && t) {
        ...
        function rn(e, t, n, r, i) {
            var s = t.line, o = t.ch, u = e.getLine(s), a = n ? 1 : -1, f = r ? P : D;
            if (i && u == "") {
                s += a, u = e.getLine(s);
        ...
        function fn(e, t, n, r, i) {
            ...
            return r
                ...
                : (s = t.lastIndexOf(n, e - 1), s != -1 && !i && (s += 1)), s
        }
        ...
        function cn(e, t, n, r) {
            var i = t,
                ...
                l = f === a ? 1 : 0;
            s = e.scanForBracket(E(i.line, i.ch + l), -1, null, { bracketRegex: u }), o =
                e.scanForBracket(E(i.line, i.ch + l), 1, null, { bracketRegex: u });
        ...
        function mn(e) { return yn(e, "/") }

        function gn(e) { return bn(e, "/") }
        ...
        function kn(e, t) {
            var n = '<span style="font-family: monospace; white-space: pre">' +
                (e || "") +
        ...
        function An(e, t) {
            var n = (t.prefix || "") + " " + (t.desc || ""), r = kn(t.prefix, t.desc);
        ...
        function Dn(e, t) {
            var n = dn(e), r = n.getOverlay();
            if (!r || t != r.query)
                r && e.removeOverlay(r), r = _n(t), e.addOverlay(r), e.showMatchesOnScrollbar &&
                (n.getScrollbarAnnotate() && n.getScrollbarAnnotate().clear(), n.setScrollbarAnnotate(
                    e.showMatchesOnScrollbar(t))), n.setOverlay(r)
        }
        ...
        function Hn(e) {
            var t = dn(e);
            e.removeOverlay(dn(e).getOverlay()), t.setOverlay(null), t.getScrollbarAnnotate() &&
        ...
        function zn(e) {
            ...
            !i &&
                    ...
                    (nr(e, t, t.insertModeRepeat - 1, !0), t.lastEditInputState.repeatOverride =
                        t.insertModeRepeat), delete
                    t.insertModeRepeat, t.insertMode =
                    !1, e.setCursor(e.getCursor().line, e.getCursor().ch - 1), e.setOption("keyMap", "vim"),
                e.setOption("disableInput", !0), e.toggleOverwrite(!1), r.setText(s.changes.join("")), v.signal(e,
                    "vim-mode-change",
                    { mode: "normal" }), n.isRecording && Jn(n)
        }

        function Wn(e) { b.unshift(e) }
        ...
        function Vn(e, t, n, r) {
            ...
            for (var u = 0; u < s.length; u++) {
                var a = s[u], f, l;
                while (a) {
                    f = /<\w+-.+?>|<\w+>|./.exec(a), l = f[0], a =
                        a.substring(f.index + l.length), v.Vim.handleKey(e, l, "macro");
                    if (t.insertMode) {
        ...
        function $n(e, t) {
            ...
            var n = e.latestRegister, r = nt.registerController.getRegister(n);
            r && r.pushText(t)
        }

        function Jn(e) {
            if (e.isPlaying) return;
            var t = e.latestRegister, n = nt.registerController.getRegister(t);
        ...
        function Qn(e, t) {
            var n = nt.macroModeState, r = n.lastInsertModeChanges;
            if (!n.isPlaying)
                while (t) {
        ...
        function Yn(e) {
            var t = e.state.vim, n = wt(e, Lt(t.sel.head)), r = St(n, 0, 1);
            t.fakeCursor && t.fakeCursor.clear(), t.fakeCursor =
                e.markText(n, r, { className: "cm-animate-fat-cursor" })
        }
        ...
        function Zn(e, t) {
            ...
            if (t.visualMode) {
                ...
                r = St(r, 0, i), n = St(n, 0, s), t.sel =
                    { anchor: n, head: r }, an(e, t, "<", Mt(r, n)), an(e, t, ">", _t(r, n))
            } else t.insertMode || (t.lastHPos = e.getCursor().ch)
        }

        function er(e) { this.keyName = e }

        function tr(e) {
            function i() { return n.maybeReset && (n.changes = [], n.maybeReset = !1), n.changes.push(new er(r)), !0 }

            var t = nt.macroModeState, n = t.lastInsertModeChanges, r = v.keyName(e);
            if (!r) return;
            (r.indexOf("Delete") != -1 || r.indexOf("Backspace") != -1) && v.lookupKey(r, "vim-insert", i)
        }

        function nr(e, t, n, r) {
            function u() { s ? ht.processAction(e, t, t.lastEditActionCommand) : ht.evalInput(e, t) }
        ...
        function rr(e, t, n) {
            ...
            var i = e.getCursor("head"), s = nt.macroModeState.lastInsertModeChanges.inVisualBlock;
            if (s) {
            ...
            for (var f = 0; f < n; f++) {
                ...
                for (var l = 0; l < t.length; l++) {
                    ...
                    if (c instanceof er) v.lookupKey(c.keyName, "vim-insert", r);
                        ...
                        var p = e.getCursor(), d = St(p, 0, c[0].length);
        ...
        function sr(e, t, n) {
            ...
            var r = "";
            return n.ctrlKey && (r += "C-"), n.altKey && (r += "A-"), n.shiftKey && (r += "S-"), r += t, r.length > 1 &&
                (r = "<" + r + ">"), r
        }
        ...
        function ur(e) {
            ...
            return Object.keys(e).forEach(function(n) {
                ...
                Array.isArray(r) ? r = r.slice() : r && typeof r == "object" && r.constructor != Object && (r = ur(r)),
                    t[n] = r
            }), e.sel && (t.sel = { head: e.sel.head && Lt(e.sel.head), anchor: e.sel.anchor && Lt(e.sel.anchor) }), t
        }

        function ar(e, t, n) {
            var r = !1, i = S.maybeInitVimState_(e), s = i.visualBlock || i.wasInVisualBlock;
                ...
                e.operation(function() {
                        e.ace.forEachSelection(function() {
                            ...
                            var s = e.getCursor("head"),
                                ...
                                a = Ot(s, u) ? 0 : -1,
                                f = Ot(s, u) ? -1 : 0;
                            s = St(s, 0, a), u = St(u, 0, f), e.state.vim.sel.head = s, e.state.vim.sel.anchor = u, r =
                                or(e, t, n), i.$desiredColumn =
                                e.state.vim.lastHPos == -1 ? null : e.state.vim.lastHPos, e.virtualSelectionMode() &&
                                (e.state.vim = ur(o))
        ...
        e("../multi_select");
        var v = function(e) {
            this.ace = e, this.state = {}, this.marks = {}, this.$uid = 0, this.onChange =
                    this.onChange.bind(this), this.onSelectionChange =
                    this.onSelectionChange.bind(this), this.onBeforeEndOperation =
                    this.onBeforeEndOperation.bind(this), this.ace.on("change", this.onChange),
                this.ace.on("changeSelection", this.onSelectionChange), this.ace.on("beforeEndOperation",
        ...
        {
            redo: function(e) { e.ace.redo() },
            undo: function(e) { e.ace.undo() },
            newlineAndIndent: function(e) { e.ace.insert("\n") }
        }, v.keyMap = {}, v.addClass = v.rmClass = function() {}, v.e_stop = v.e_preventDefault =
            f.stopEvent, v.keyName = function(e) {
            var t = a[e.keyCode] || e.key || "";
            return t.length == 1 && (t = t.toUpperCase()), t =
                f.getModifierString(e).replace(/(^|-)\w/g, function(e) { return e.toUpperCase() }) + t, t
        ...
        }, v.signal = function(e, t, n) { return e._signal(t, n) }, v.on = f.addListener, v.off =
            f.removeListener, v.isWordChar =
            function(e) { return e < "" ? /^\w$/.test(e) : (d.lastIndex = 0, d.test(e)) }, function() {
            u.implement(v.prototype, s), this.destroy =
                function() {
                    this.ace.off("change", this.onChange), this.ace.off("changeSelection", this.onSelectionChange),
                        this.ace.off("beforeEndOperation", this.onBeforeEndOperation), this.removeOverlay()
                }, this.virtualSelectionMode =
                function() { return this.ace.inVirtualSelectionMode && this.ace.selection.index }, this.onChange =
                function(e) {
                    ...
                    n.lastChange ? n.lastChange.next = n.lastChange = t : n.lastChange = n.change = t, this
                        .$updateMarkers(e)
                ...
                e.cursorActivityHandlers ||
                    ...
                    this.curOp.cursorActivity = !0, this.ace.inMultiSelectMode &&
                ...
                this.curOp.force = t;
                var i = e();
                return this.ace.curOp &&
                        this.ace.curOp.command.name == "vim" &&
                        (this.ace.endOperation(), !r.cursorActivity && !r.lastChange && n && (this.ace.prevOp = n)),
                    (t || !this.ace.curOp) && this.curOp && this.onBeforeEndOperation(), i
            }, this.onBeforeEndOperation = function() {
                var e = this.curOp;
                e &&
                (e.change && this.signal("change", e.change, e), e &&
                    e.cursorActivity &&
                    this.signal("cursorActivity", null, e), this.curOp = null)
            }, this.signal = function(e, t, n) {
                var r = n ? n[e + "Handlers"] : (this._eventRegistry || {})[e];
                if (!r) return;
                r = r.slice();
                for (var i = 0; i < r.length; i++) r[i](this, t)
            }, this.firstLine = function() { return 0 }, this.lastLine =
                function() { return this.ace.session.getLength() - 1 }, this.lineCount =
                function() { return this.ace.session.getLength() }, this.setCursor = function(e, t) {
                typeof e == "object" && (t = e.ch, e = e.line), this.ace.inVirtualSelectionMode ||
                    this.ace.exitMultiSelectMode(), this.ace.session.unfold({ row: e, column: t }), this.ace.selection
                    .moveTo(e, t)
                ...
                r.moveTo(e.line, e.ch), r.selectTo(t.line, t.ch), n &&
                    n.origin == "*mouse" &&
                    this.onBeforeEndOperation()
            }, this.somethingSelected = function(e) { return!this.ace.selection.isEmpty() }, this.clipPos =
                function(e) {
                    var t = this.ace.session.$clipPositionToDocument(e.line, e.ch);
                    return g(t)
                }, this.markText =
                function(e) { return{ clear: function() {}, find: function() {} } }, this.$updateMarkers = function(e) {
            ...
            e.prototype.clear = function() { delete this.cm.marks[this.id] }, e.prototype.find =
                    function() { return g(this) }, this.setBookmark = function(t, n) {
                    ...
                    if (n == "line") {
                        ...
                        r != null && (o.column = r), o.row += t, o.row =
                            Math.min(Math.max(0, o.row), this.ace.session.getScreenLength() - 1);
                    ...
                    return{
                        ...
                        find: function(t) {
                            ...
                            return n &&
                                ...
                                (s.$options.start = n, n = s.find(u.ace.session)), a = n, a
                        },
                    ...
                    i -= (n.$size.scrollerHeight - n.lineHeight) * n.$scrollPastEnd, t != null &&
                        this.ace.session.setScrollTop(Math.max(0, Math.min(t, i))), e != null &&
                ...
                }, this.getLine = function(e) { return this.ace.session.getLine(e) }, this.getRange =
                    function(e, t) { return this.ace.session.getTextRange(new i(e.line, e.ch, t.line, t.ch)) },
                this.replaceRange =
                    function(e, t, n) {
                ...
                }, this.getSelection = function() { return this.ace.getSelectedText() }, this.getSelections =
                    function() {
                        return this.listSelections().map(function(e) { return this.getRange(e.anchor, e.head) }, this)
                    }, this.getInputField =
                    function() { return this.ace.textInput.getElement() }, this.getWrapperElement =
                    function() { return this.ace.containter };
            var t = {
            ...
            this.setOption = function(e, n) {
                ...
                function(e) { return this.state.overwrite = e, this.ace.setOverwrite(e) }, this.addOverlay =
                function(e) {
                    if (!this.$searchHighlight || !this.$searchHighlight.session) {
                        ...
                        t.id = n.id, t.session = this.ace.session, t.destroy = function(e) {
                            t.session.off("change", t.updateOnChange), t.session.off("changeEditor", t.destroy), t
                                .session.removeMarker(t.id), t.session = null
                    ...
                    this.$searchHighlight = e.highlight =
                        t, this.$searchHighlight.setRegexp(r), this.ace.renderer.updateBackMarkers()
                }, this.removeOverlay =
                function(e) {
            ...
            }, this.getValue = function() { return this.ace.getValue() }, this.setValue =
                function(e) { return this.ace.setValue(e) }, this.getTokenTypeAt = function(e) {
                ...
                function(e) { return this.ace.session.doc.positionToIndex(m(e)) }, this.posFromIndex =
                function(e) { return g(this.ace.session.doc.indexToPosition(e)) }, this.focus =
                function(e) { return this.ace.textInput.focus() }, this.blur =
                function(e) { return this.ace.blur() }, this.defaultTextHeight =
                function(e) { return this.ace.renderer.layerConfig.lineHeight }, this.scanForBracket =
                function(e, t, n, r) {
                    ...
                    if (t == 1) var s = this.ace.session.$findClosingBracket(i.slice(1, 2), m(e), /paren|text/);
                        ...
                        var s = this.ace.session.$findOpeningBracket(i.slice(-2, -1),
                            ...
                            /paren|text/);
                    return s && { pos: g(s) }
                }, this.refresh = function() { return this.ace.resize(!0) }, this.getMode = function() {
                return{ name: this.getOption("mode") }
            }
        }.call(v.prototype);
        var y = v.StringStream = function(e, t) {
            this.pos = this.start = 0, this.string = e, this.tabSize = t || 8, this.lastColumnPos =
                this.lastColumnValue = 0, this.lineStart = 0
        };
        y.prototype = {
        ...
        }, v.defineExtension = function(e, t) { v.prototype[e] = t }, o.importCssString(
            ...
            function e(e, t, n) {
                ...
                return i = r.appendChild(document.createElement("div")), n
                    ? i.className = "ace_dialog ace_dialog-bottom"
                    : i.className = "ace_dialog ace_dialog-top", typeof t == "string"
                    ? i.innerHTML = t
                    : i.appendChild(t), i
            }
            ...
            v.defineExtension("openDialog",
                function(n, r, i) {
                    ...
                    if (f)
                        i.value && (f.value = i.value, i.selectValueOnOpen !== !1 && f.select()), i.onInput &&
                            v.on(f, "input", function(e) { i.onInput(e, f.value, a) }), i.onKeyUp &&
                            v.on(f, "keyup", function(e) { i.onKeyUp(e, f.value, a) }), v.on(f,
                            "keydown",
                            function(e) {
                        ...
                        v.on(l, "click", function() { a(), u.focus() }), i.closeOnBlur !== !1 && v.on(l, "blur", a), l
                            .focus();
                    return a
                }), v.defineExtension("openNotification",
                function(n, r) {
                    function a() {
                        if (s) return;
                    ...
                    return v.on(i, "click", function(e) { v.e_preventDefault(e), a() }), u && (o = setTimeout(a, u)), a
                })
        }();
        var b =
            [
                { keys: "<Left>", type: "keyToKey", toKeys: "h" }, { keys: "<Right>", type: "keyToKey", toKeys: "l" },
                ...
                { keys: "<Home>", type: "keyToKey", toKeys: "0" }, { keys: "<End>", type: "keyToKey", toKeys: "$" },
                ...
                { keys: "y", type: "operator", operator: "yank" }, { keys: "c", type: "operator", operator: "change" },
                ...
                },
                {
                    keys: "g#",
                    type: "search",
                    searchArgs: { forward: !1, querySrc: "wordUnderCursor", toJumplist: !0 }
                }, { keys: ":", type: "ex" }
            ],
            w = [
                { name: "colorscheme", shortName: "colo" }, { name: "map" }, { name: "imap", shortName: "im" },
                { name: "nmap", shortName: "nm" }, { name: "vmap", shortName: "vm" }, { name: "unmap" },
                { name: "write", shortName: "w" }, { name: "undo", shortName: "u" }, { name: "redo", shortName: "red" },
                { name: "set", shortName: "se" }, { name: "set", shortName: "se" },
                { name: "setlocal", shortName: "setl" },
                { name: "setglobal", shortName: "setg" }, { name: "sort", shortName: "sor" },
                { name: "substitute", shortName: "s", possiblyAsync: !0 }, { name: "nohlsearch", shortName: "noh" },
                { name: "yank", shortName: "y" }, { name: "delmarks", shortName: "delm" },
                { name: "registers", shortName: "reg", excludeFromCommandHistory: !0 },
                { name: "global", shortName: "g" }
            ],
            E = v.Pos,
            S = function() { return st };
        v.defineOption("vimMode",
            !1,
            function(e, t, n) {
        ...
        var L = { Shift: "S", Ctrl: "C", Alt: "A", Cmd: "D", Mod: "A" },
            ...
            _ = /[\d]/,
            D = [v.isWordChar, function(e) { return e && !v.isWordChar(e) && !/\s/.test(e) }],
            P = [function(e) { return/\S/.test(e) }],
            B = H(65, 26),
            j = H(97, 26),
            F = H(48, 10),
            I = [].concat(B, j, F, ["<", ">"]),
        ...
        et.prototype = {
            ...
            enterMacroRecordMode: function(e, t) {
                ...
                n &&
                (n.clear(), this.latestRegister =
                    t, e.openDialog &&
                    (this.onRecordingDone = e.openDialog("(recording)[" + t + "]", null, { bottom: !0 })), this
                    .isRecording = !0)
            }
        };
        var nt,
            ...
            st = {
                ...
                getRegisterController: function() { return nt.registerController },
                resetVimGlobalState_: rt,
                getVimGlobalState_: function() { return nt },
                maybeInitVimState_: tt,
                suppressErrorLogging: !1,
                InsertModeKey: er,
                map: function(e, t, n) { Rn.map(e, t, n) },
                unmap: function(e, t) { Rn.unmap(e, t) },
                setOption: Q,
                getOption: G,
                defineOption: K,
                ...
                findKey: function(e, t, n) {
                    ...
                    function s() { if (t == "<Esc>") return ut(e), r.visualMode ? $t(e) : r.insertMode && zn(e), !0 }

                    function o(n) {
                        var r;
                        while (n)
                            r = /<\w+-.+?>|<\w+>|./.exec(n), t = r[0], n =
                                n.substring(r.index + t.length), v.Vim.handleKey(e, t, "mapping")
                    }
                    ...
                    function u() {
                        ...
                        if (o.type == "partial")
                            return it && window.clearTimeout(it), it = window.setTimeout(
                                function() { r.insertMode && r.inputState.keyBuffer && ut(e) },
                    ...
                    var r = tt(e), f;
                    return r.insertMode ? f = u() : f = a(), f === !1
                        ? undefined
                        : f === !0
                        ? function() { return!0 }
                        : function() {
                            ...
                            return e.operation(function() {
                                ...
                                try {
                                    ...
                                    throw e.state.vim =
                                        undefined, tt(e), v.Vim.suppressErrorLogging || console.log(t), t
                                }
                                return!0
                            })
                        }
                },
                handleEx: function(e, t) { Rn.processCommand(e, t) },
                defineMotion: dt,
                defineAction: bt,
                defineOperator: gt,
                mapCommand: Xn,
        ...
        ot.prototype.pushRepeatDigit =
            ...
            if (this.prefixRepeat.length > 0 || this.motionRepeat.length > 0)
                e = 1, this.prefixRepeat.length > 0 && (e *= parseInt(this.prefixRepeat.join(""), 10)),
                    this.motionRepeat.length > 0 && (e *= parseInt(this.motionRepeat.join(""), 10));
            return e
        }, at.prototype =
        {
            setText: function(e, t, n) { this.keyBuffer = [e || ""], this.linewise = !!t, this.blockwise = !!n },
            pushText: function(e, t) {
                t && (this.linewise || this.keyBuffer.push("\n"), this.linewise = !0), this.keyBuffer.push(e)
            },
            pushInsertModeChanges: function(e) { this.insertModeChanges.push(Z(e)) },
            pushSearchQuery: function(e) { this.searchQueries.push(e) },
            clear: function() {
                this.keyBuffer = [], this.insertModeChanges = [], this.searchQueries = [], this.linewise = !1
            },
            toString: function() { return this.keyBuffer.join("") }
        }, lt.prototype = {
            ...
            isValidRegister: function(e) { return e && $(e, q) },
        ...
        var ht = {
                ...
                processOperatorMotion: function(e, t, n) {
                    var r = t.visualMode, i = Et(n.operatorMotionArgs);
                    i && r && i.visualLine && (t.visualLine = !0), this.processOperator(e, t, n), r ||
                        this.processMotion(e, t, n)
                },
                processAction: function(e, t, n) {
                    var r = t.inputState, i = r.getRepeat(), s = !!i, o = Et(n.actionArgs) || {};
                    r.selectedCharacter && (o.selectedCharacter = r.selectedCharacter),
                        n.operator && this.processOperator(e, t, n), n.motion && this.processMotion(e, t, n),
                        (n.motion || n.operator) && this.evalInput(e, t), o.repeat = i || 1, o.repeatIsExplicit =
                            s, o.registerName = r.registerName, ut(e), t.lastMotion =
                            null, n.isEdit && this.recordLastEdit(t, r, n), yt[n.action](e, o, t)
                },
                processSearch: function(e, t, n) {
                    ...
                    function l(t, n, i) {
                        ...
                        s == "Up" || s == "Down"
                            ? (o = s == "Up" ? !0 : !1, a = t.target ? t.target.selectionEnd : 0, n =
                                nt.searchHistoryController.nextMatch(n, o) || "", i(n), a &&
                                t.target &&
                                (t.target.selectionEnd = t.target.selectionStart = Math.min(a, t.target.value.length)))
                            : s != "Left" &&
                            s != "Right" &&
                            s != "Ctrl" &&
                            s != "Alt" &&
                    ...
                    function c(t, n, r) {
                        ...
                        i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" || i == "Backspace" && n == ""
                            ? (nt.searchHistoryController.pushInput(n), nt.searchHistoryController.reset(), Mn(e, o),
                                Hn(e), e.scrollTo(u.left, u.top), v.e_stop(t), ut(e), r(), e.focus())
                            : i == "Up" || i == "Down"
                            ? v.e_stop(t)
                    ...
                    dn(e).setReversed(!r);
                    var s = r ? "/" : "?", o = dn(e).getQuery(), u = e.getScrollInfo();
                    ...
                    case"wordUnderCursor":
                        ...
                        m && i ? p = "\\b" + p + "\\b" : p = Bt(p), nt.jumpList.cachedCursor =
                            e.getCursor(), e.setCursor(d.start), a(p, !0, !1)
                    }
                },
                processEx: function(e, t, n) {
                    function r(t) {
                        nt.exCommandHistoryController.pushInput(t), nt.exCommandHistoryController.reset(), Rn
                            .processCommand(e, t)
                    }
                    ...
                    function i(t, n, r) {
                        ...
                        if (i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" || i == "Backspace" && n == "")
                            nt.exCommandHistoryController.pushInput(n), nt.exCommandHistoryController.reset(),
                                v.e_stop(t), ut(e), r(), e.focus();
                        i == "Up" || i == "Down"
                            ? (v.e_stop(t), s = i == "Up" ? !0 : !1, o = t.target ? t.target.selectionEnd : 0, n =
                                nt.exCommandHistoryController.nextMatch(n, s) || "", r(n), o &&
                                t.target &&
                                (t.target.selectionEnd = t.target.selectionStart = Math.min(o, t.target.value.length)))
                            : i == "Ctrl-U"
                            ? (v.e_stop(t), r(""))
                            : i != "Left" &&
                            i != "Right" &&
                ...
                evalInput: function(e, t) {
                    var n = t.inputState,
                        ...
                        d,
                        v;
                    s && this.recordLastEdit(t, n), n.repeatOverride !== undefined
                        ? v = n.repeatOverride
                        : v = n.getRepeat();
                    if (v > 0 && i.explicitRepeat) i.repeatIsExplicit = !0;
                    else if (i.noRepeat || !i.explicitRepeat && v === 0) v = 1, i.repeatIsExplicit = !1;
                    n.selectedCharacter && (i.selectedCharacter = o.selectedCharacter = n.selectedCharacter), i.repeat =
                        v, ut(e);
                    if (r) {
                        var m = pt[r](e, f, i, t);
                        t.lastMotion = pt[r];
                        ...
                        if (t.visualMode) {
                            ...
                            d && (d = wt(e, d, !0)), d = d || h, a.anchor = d, a.head =
                                p, Wt(e), an(e, t, "<", Ot(d, p) ? d : p), an(e, t, ">", Ot(d, p) ? p : d)
                    ...
                    if (s) {
                        if (o.lastSel) {
                            ...
                            b.visualLine
                                ...
                                ? p = E(h.line, h.ch + S)
                                : p = E(h.line + w, h.ch), t.visualMode = !0, t.visualLine =
                                b.visualLine, t.visualBlock = b.visualBlock, a = t.sel = { anchor: d, head: p }, Wt(e)
                        } else
                            t.visualMode &&
                            (o.lastSel = {
                                anchor: Lt(a.anchor),
                        ...
                        var x, T, N, C, k;
                        if (t.visualMode) {
                            x = Mt(a.head, a.anchor), T = _t(a.head, a.anchor), N = t.visualLine || o.linewise, C =
                                t.visualBlock ? "block" : N ? "line" : "char", k = Xt(e, { anchor: x, head: T }, C);
                            if (N) {
                                var L = k.ranges;
                                if (C == "block")
                        ...
                        e.setSelections(k.ranges, k.primary), t.lastMotion = null, o.repeat = v, o.registerName =
                            u, o.linewise = N;
                ...
                recordLastEdit: function(e, t, n) {
                    ...
                    e.lastEditInputState = t, e.lastEditActionCommand = n, r.lastInsertModeChanges.changes =
            ...
            pt = {
                ...
                moveToMiddleLine: function(e) {
                    var t = jn(e), n = Math.floor((t.top + t.bottom) * .5);
                ...
                moveByLines: function(e, t, n, r) {
                    ...
                    return l && (n.forward ? u > l.start.row && (u = l.end.row + 1) : u = l.start.row), n.toFirstChar &&
                        (s = Qt(e.getLine(u)), r.lastHPos = s), r.lastHSPos = e.charCoords(E(u, s), "div").left, E(u, s)
                },
                ...
                moveByWords: function(e, t, n) { return sn(e, t, n.repeat, !!n.forward, !!n.wordEnd, !!n.bigWord) },
                moveTillCharacter: function(e, t, n) {
                    var r = n.repeat, i = on(e, r, n.forward, n.selectedCharacter), s = n.forward ? -1 : 1;
                ...
                moveToEol: function(e, t, n, r) {
                    var i = t;
                    r.lastHPos = Infinity;
                    var s = E(i.line + n.repeat - 1, Infinity), o = e.clipPos(s);
                ...
                moveToStartOfLine: function(e, t) { return E(t.line, 0) },
            ...
            mt = {
                ...
                "delete": function(e, t, n) {
                    ...
                    if (!s.visualBlock) {
                        ...
                        t.linewise &&
                            ...
                            o.line == e.lastLine() &&
                            o.line == u.line - 1 &&
                            (o.line == e.firstLine() ? o.ch = 0 : o = E(o.line - 1, Pt(e, o.line - 1))), i =
                            e.getRange(o, u), e.replaceRange("", o, u), r =
                            o, t.linewise && (r = pt.moveToFirstNonWhiteSpaceCharacter(e, o))
                    } else {
                        i = e.getSelection();
                        var a = vt("", n.length);
                ...
                changeCase: function(e, t, n, r, i) {
                    ...
                    return e.replaceSelections(o), t.shouldMoveCursor
                        ? i
            ...
            yt = {
                ...
                scroll: function(e, t, n) {
                    ...
                    if (t.forward)
                        u > f.top
                            ? (a.line += (u - f.top) / i, a.line = Math.ceil(a.line), e.setCursor(a), f =
                                e.charCoords(a, "local"), e.scrollTo(null, f.top))
                            : e.scrollTo(null, u);
                    else {
                        var l = u + e.getScrollInfo().clientHeight;
                        l < f.bottom
                            ? (a.line -= (f.bottom - l) / i, a.line = Math.floor(a.line), e.setCursor(a), f =
                                e.charCoords(a, "local"), e.scrollTo(null, f.bottom - e.getScrollInfo().clientHeight))
                            : e.scrollTo(null, u)
                    }
                },
                ...
                replayMacro: function(e, t, n) {
                    var r = t.selectedCharacter, i = t.repeat, s = nt.macroModeState;
                    r == "@" && (r = s.latestRegister);
                    while (i--) Vn(e, n, s, r)
                },
                enterMacroRecordMode: function(e, t) {
                    var n = nt.macroModeState, r = t.selectedCharacter;
                    nt.registerController.isValidRegister(r) && n.enterMacroRecordMode(e, r)
                },
                toggleOverwrite: function(e) {
                    e.state.overwrite
                        ? (e.toggleOverwrite(!1), e.setOption("keyMap", "vim-insert"),
                            v.signal(e, "vim-mode-change", { mode: "insert" }))
                        : (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"), v.signal(e,
                            "vim-mode-change",
                            { mode: "replace" }))
                },
                enterInsertMode: function(e, t, n) {
                    ...
                    if (r == "eol") s = E(s.line, Pt(e, s.line));
                        ...
                        n.visualBlock
                            ? (s = E(Math.min(i.head.line, i.anchor.line), Math.min(i.head.ch, i.anchor.ch)), o =
                                Math.abs(i.head.line - i.anchor.line) + 1)
                            : i.head.line < i.anchor.line
                            ? s = i.head
                            : s = E(i.anchor.line, 0);
                    else if (r == "endOfSelectedArea")
                        n.visualBlock
                            ? (s = E(Math.min(i.head.line, i.anchor.line), Math.max(i.head.ch + 1, i.anchor.ch)), o =
                                Math.abs(i.head.line - i.anchor.line) + 1)
                            : i.head.line >= i.anchor.line
                            ? s = St(i.head, 0, 1)
                            : s = E(i.anchor.line, 0);
                    else if (r == "inplace" && n.visualMode) return;
                    e.setOption("disableInput", !1), t && t.replace
                        ? (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"),
                            v.signal(e, "vim-mode-change", { mode: "replace" }))
                        : (e.toggleOverwrite(!1), e.setOption("keyMap", "vim-insert"), v.signal(e,
                            "vim-mode-change",
                            { mode: "insert" })), nt.macroModeState.isPlaying ||
                        (e.on("change", Qn), v.on(e.getInputField(), "keydown", tr)), n.visualMode && $t(e), It(e, s, o)
                },
                toggleVisualMode: function(e, t, n) {
                    var r = t.repeat, i = e.getCursor(), s;
                    n.visualMode
                        ? n.visualLine ^ t.linewise || n.visualBlock ^ t.blockwise
                        ? (n.visualLine = !!t.linewise, n.visualBlock =
                                !!t.blockwise,
                            v.signal(e,
                                "vim-mode-change",
                                {
                            ...
                            Wt(e))
                        : $t(e)
                        : (n.visualMode = !0, n.visualLine = !!t.linewise, n.visualBlock = !!t.blockwise, s =
                                wt(e, E(i.line, i.ch + r - 1), !0), n.sel =
                                { anchor: i, head: s }, v.signal(e,
                                "vim-mode-change",
                                {
                                    mode: "visual",
                                    subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : ""
                ...
                reselectLastSelection: function(e, t, n) {
                    ...
                    if (r) {
                        ...
                        if (!i || !s) return;
                        n.sel = { anchor: i, head: s }, n.visualMode = !0, n.visualLine = r.visualLine, n.visualBlock =
                            r.visualBlock, Wt(e), an(e, n, "<", Mt(i, s)), an(e, n, ">", _t(i, s)), v.signal(e,
                            "vim-mode-change",
                            { mode: "visual", subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : "" })
                    }
                },
                ...
                paste: function(e, t, n) {
                    var r = Lt(e.getCursor()), i = nt.registerController.getRegister(t.registerName), s = i.toString();
                    if (!s) return;
                    if (t.matchIndent) {
                    ...
                    if (n.visualMode) {
                        ...
                        n.lastSelection && (y = n.lastSelection.headMark.find()),
                            nt.registerController.unnamedRegister.setText(x), d
                                ? (e.replaceSelections(N), S =
                                    E(w.line + s.length - 1, w.ch), e.setCursor(w), Ft(e, S), e.replaceSelections(s),
                                m = w)
                                : n.visualBlock
                                ? (e.replaceSelections(N), e.setCursor(w), e.replaceRange(s, w, w), m = w)
                                : (e.replaceRange(s, w, S), m = e.posFromIndex(e.indexFromPos(w) + s.length - 1)), y &&
                                (n.lastSelection.headMark = e.setBookmark(y)), p && (m.ch = 0)
                    } else if (d) {
                        e.setCursor(r);
                ...
                undo: function(e, t) {
                    e.operation(function() { kt(e, v.commands.undo, t.repeat)(), e.setCursor(e.getCursor("anchor")) })
                },
                redo: function(e, t) { kt(e, v.commands.redo, t.repeat)() },
                ...
                replace: function(e, t, n) {
                    ...
                    if (r == "\n")
                        n.visualMode || e.replaceRange("", i, o), (v.commands.newlineAndIndentContinueComment ||
                ...
                repeatLastEdit: function(e, t, n) {
                    ...
                    i && t.repeatIsExplicit
                        ...
                        : i = n.lastEditInputState.repeatOverride || i, nr(e, n, i, !1)
                },
                indent: function(e, t) { e.indentLine(e.getCursor().line, t.indentRight) },
                exitInsertMode: zn
            },
            en = {
                "(": "bracket",
            ...
            tn = {
                ...
                section: {
                    ...
                    isComplete: function(e) { return e.index === 0 && e.nextCh === e.symb }
                },
                comment: {
                    isComplete: function(e) {
                ...
                method: {
                    ...
                    isComplete: function(e) { return e.nextCh === e.symb ? !0 : !1 }
                },
                preprocess: {
        ...
        K("pcre", !0, "boolean"), pn.prototype = {
            getQuery: function() { return nt.query },
            setQuery: function(e) { nt.query = e },
            getOverlay: function() { return this.searchOverlay },
            setOverlay: function(e) { this.searchOverlay = e },
            isReversed: function() { return nt.isReversed },
            setReversed: function(e) { nt.isReversed = e },
            getScrollbarAnnotate: function() { return this.annotate },
            setScrollbarAnnotate: function(e) { this.annotate = e }
        };
        var En = { "\\n": "\n", "\\r": "\r", "\\t": "	" },
            xn = { "\\/": "/", "\\\\": "\\", "\\n": "\n", "\\r": "\r", "\\t": "	" },
            Ln = "(Javascript regexp)",
            In = function() { this.buildCommandMap_() };
        In.prototype = {
            processCommand: function(e, t, n) {
                var r = this;
            ...
            _processCommand: function(e, t, n) {
                var r = e.state.vim, i = nt.registerController.getRegister(":"), s = i.toString();
                r.visualMode && $t(e);
            ...
            parseInput_: function(e, t, n) {
                t.eatWhile(":"), t.eat("%")
                    ...
                    : (n.line = this.parseLineSpec_(e, t), n.line !== undefined &&
                        t.eat(",") &&
            ...
            parseLineSpec_: function(e, t) {
                ...
                case"'":
                    var r = t.next(), i = Fn(e, e.state.vim, r);
            ...
            parseCommandArgs_: function(e, t, n) {
                ...
                var r = n.argDelimiter || /\s+/, i = Ht(t.argString).split(r);
        ...
        var qn = {
                ...
                registers: function(e, t) {
                    var n = t.args, r = nt.registerController.registers, i = "----------Registers----------<br><br>";
                    if (!n)
                        for (var s in r) {
                            var o = r[s].toString();
                            o.length && (i += '"' + s + "    " + o + "<br>")
                ...
                sort: function(e, t) {
                    ...
                    function S(e, t) {
                        ...
                        return o
                            ? (o = parseInt((o[1] + o[2]).toLowerCase(), m), u =
                                parseInt((u[1] + u[2]).toLowerCase(), m), o - u)
                            : e < t
                            ? -1
                            : 1
                    }
                ...
                substitute: function(e, t) {
                    ...
                    if (r.length)
                        i = r[0], s =
                            ...
                            (G("pcre") ? s = Tn(s) : s = Sn(s), nt.lastSubstituteReplacePart = s), o =
                            r[2] ? r[2].split(" ") : [];
                    else if (n && n.length) {
                    ...
                    o &&
                    (u = o[0], a = parseInt(o[1]), u &&
                    (u.indexOf("c") != -1 && (f = !0, u.replace("c", "")), u.indexOf("g") != -1 &&
                        (l = !0, u.replace("g", "")), i = i.replace(/\//g, "\\/") + "/" + u));
                    if (i)
                        try {
                            Mn(e, i, !0, !0)
                        } catch (c) {
                    ...
                    var m = wt(e, E(d, 0)), g = e.getSearchCursor(p, m);
                    Un(e, f, l, d, v, g, p, s, t.callback)
                },
                redo: v.commands.redo,
                undo: v.commands.undo,
                write: function(e) { v.commands.save ? v.commands.save(e) : e.save && e.save() },
                nohlsearch: function(e) { Hn(e) },
                yank: function(e) {
                    var t = Lt(e.getCursor()), n = t.line, r = e.getLine(n);
                ...
                delmarks: function(e, t) {
                    ...
                    var n = e.state.vim, r = new v.StringStream(Ht(t.argString));
                    while (!r.eol()) {
                        r.eatSpace();
                        var i = r.pos;
                        if (!r.match(/[a-zA-Z]/, !1)) {
            ...
            Rn = new In;
        v.keyMap.vim =
            { attach: C, detach: N, call: k }, K("insertModeEscKeysTimeout", 200, "number"), v.keyMap["vim-insert"] = {
            "Ctrl-N": "autocomplete",
            "Ctrl-P": "autocomplete",
            Enter: function(e) {
            ...
            { Backspace: "goCharLeft", fallthrough: ["vim-insert"], attach: C, detach: N, call: k }, rt(), v.Vim =
            S(), S = v.Vim;
        var ir = {
                "return": "CR",
                backspace: "BS",
        ...
        S.handleKey = function(e, t, n) { return e.operation(function() { return or(e, t, n) }, !0) }, t.CodeMirror = v;
        ...
        t.handler = {
            ...
            drawCursor: function(e, t, n, r, s) {
                ...
                !o.insertMode && o.status && (a /= 2, f += a), e.left = l + "px", e.top = f + "px", e.width =
                    u + "px", e.height = a + "px"
            },
            handleKeyboard: function(e, t, n, r, i) {
                var s = e.editor, o = s.state.cm, u = fr(o);
                if (r == -1) return;
                u.insertMode ||
                (t == -1
                    ? (n.charCodeAt(0) > 255 &&
                        e.inputKey &&
                        (n = e.inputKey, n && e.inputHash == 4 && (n = n.toUpperCase())), e.inputChar = n)
                    : t == 4 || t == 0
                ...
                if (n == "c" && t == 1 && !c.isMac && s.getCopyText())
                    return s.once("copy", function() { s.selection.clearSelection() }), {
                        command: "null",
                        passEvent: !0
                    };
                if (n == "esc" && !u.insertMode && !u.visualMode && !o.ace.inMultiSelectMode) {
                    var a = dn(o), f = a.getOverlay();
                    f && o.removeOverlay(f)
                }
                if (t == -1 || t & 1 || t === 0 && n.length > 1) {
                    var l = u.insertMode, h = sr(t, n, i || {});
                    u.status == null && (u.status = "");
                    var p = ar(o, h, "user");
                    u = fr(o), p && u.status != null ? u.status += h : u.status == null && (u.status = ""), o._signal(
                        "changeStatus");
                    if (!p && (t != -1 || l)) return;
            ...
            attach: function(e) {
                function n() {
                    ...
                    t.ace.renderer.setStyle("normal-mode", !n), e.textInput.setCommandMode(!n), e.renderer
                        .$keepTextAreaAtCursor = n, e.renderer.$blockCursor = !n
                }

                e.state || (e.state = {});
                var t = new v(e);
                e.state.cm = t, e.$vimModeHandler = this, v.keyMap.vim.attach(t), fr(t).status = null, t.on(
                    "vim-command-done",
                    function() {
                        if (t.virtualSelectionMode()) return;
                        fr(t).status = null, t.ace._signal("changeStatus"), t.ace.session.markUndoGroup()
                    }), t.on("changeStatus",
                    function() { t.ace.renderer.updateCursor(), t.ace._signal("changeStatus") }), t.on(
                    "vim-mode-change",
                    function() {
                        if (t.virtualSelectionMode()) return;
                        n(), t._signal("changeStatus")
                    }), n(), e.renderer.$cursorLayer.drawCursor =
                    this.drawCursor.bind(t), this.updateMacCompositionHandlers(e, !0)
            },
            detach: function(e) {
                var t = e.state.cm;
                v.keyMap.vim.detach(t), t.destroy(), e.state.cm = null, e.$vimModeHandler =
                        null, e.renderer.$cursorLayer.drawCursor =
                        null, e.renderer.setStyle("normal-mode", !1), e.textInput.setCommandMode(!1),
                    e.renderer.$keepTextAreaAtCursor = !0, this.updateMacCompositionHandlers(e, !1)
            },
            getStatusText: function(e) {
                var t = e.state.cm, n = fr(t);
                if (n.insertMode) return"INSERT";
                var r = "";
                return n.visualMode &&
                    (r += "VISUAL", n.visualLine && (r += " LINE"), n.visualBlock && (r += " BLOCK")), n.status &&
                    (r += (r ? " " : "") + n.status), r
            },
            updateMacCompositionHandlers: function(e, t) {
                var n = function(t) {
                        var n = e.state.cm, r = fr(n);
                        if (!r.insertMode) {
        ...
        var lr = {
            ...
            getWidth: function(e, t, n) { return e.getLength().toString().length * n.characterWidth },
            update: function(e, t) { t.renderer.$loop.schedule(t.renderer.CHANGE_GUTTER) },
            attach: function(e) { e.renderer.$gutterLayer.$renderer = this, e.on("changeSelection", this.update) },
            detach: function(e) { e.renderer.$gutterLayer.$renderer = null, e.off("changeSelection", this.update) }
        };
        S.defineOption({ name: "wrap", set: function(e, t) { t && t.ace.setOption("wrap", e) }, type: "boolean" }, !1),
            S.defineEx("write", "w", function() { console.log(":write is not implemented") }), b.push(
            ...
            yt.aceCommand =
                ...
                function(e, t, n) {
                    e.ace.execCommand(
                        ["toggleFoldWidget", "toggleFoldWidget", "foldOther", "unfoldall"][(t.all ? 2 : 0) +
                            (t.open ? 1 : 0)])
                }, t.handler.defaultKeymap = b, t.handler.actions = yt, t.Vim = S, S.map("Y", "yy", "normal")
    });
(function() {
    window.require(["ace/keyboard/vim"],
        function(m) {
