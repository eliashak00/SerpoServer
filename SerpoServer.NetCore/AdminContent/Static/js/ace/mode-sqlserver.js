define("ace/mode/doc_comment_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            o = function() {
                ...
                s +=
                    ...
                    s += "|LOOP|HASH|MERGE|REMOTE", s += "|TRY|CATCH|THROW", s += "|TYPE", s = s.split("|"), s =
                        s.filter(function(r, i, s) {
                            return e.split("|").indexOf(r) === -1 &&
                                t.split("|").indexOf(r) === -1 &&
                                n.split("|").indexOf(r) === -1
                        }), s = s.sort().join("|");
                var o =
                        this.createKeywordMapper({
                            ...
                            !0),
                    u =
                        "SET ANSI_DEFAULTS|SET ANSI_NULLS|SET ANSI_NULL_DFLT_OFF|SET ANSI_NULL_DFLT_ON|SET ANSI_PADDING|SET ANSI_WARNINGS|SET ARITHABORT|SET ARITHIGNORE|SET CONCAT_NULL_YIELDS_NULL|SET CURSOR_CLOSE_ON_COMMIT|SET DATEFIRST|SET DATEFORMAT|SET DEADLOCK_PRIORITY|SET FIPS_FLAGGER|SET FMTONLY|SET FORCEPLAN|SET IDENTITY_INSERT|SET IMPLICIT_TRANSACTIONS|SET LANGUAGE|SET LOCK_TIMEOUT|SET NOCOUNT|SET NOEXEC|SET NUMERIC_ROUNDABORT|SET OFFSETS|SET PARSEONLY|SET QUERY_GOVERNOR_COST_LIMIT|SET QUOTED_IDENTIFIER|SET REMOTE_PROC_TRANSACTIONS|SET ROWCOUNT|SET SHOWPLAN_ALL|SET SHOWPLAN_TEXT|SET SHOWPLAN_XML|SET STATISTICS IO|SET STATISTICS PROFILE|SET STATISTICS TIME|SET STATISTICS XML|SET TEXTSIZE|SET XACT_ABORT"
                            .split("|"),
                    ...
                    start: [
                        {
                            ...
                            next: [
                                ...
                                { token: "string.end", next: "start", regex: "'" }, { defaultToken: "string" }
                            ]
                        ...
                        { token: "punctuation", regex: ",|;" }, { token: "text", regex: "\\s+" }
                    ],
                    comment: [
                ...
                var l = [],
                    c = function(e, t) { e.forEach(function(e) { l.push({ name: e, value: e, score: 0, meta: t }) }) };
                c(r.split("|"), "procedure"), c(e.split("|"), "operator"), c(t.split("|"), "function"),
                    c(n.split("|"), "type"), c(u, "statement"), c(s.split("|"), "keyword"), this.completions = l
            };
    ...
    function(e, t, n) {
        ...
        r.inherits(o, s), function() {
            this.foldingStartMarker = /(\bCASE\b|\bBEGIN\b)|^\s*(\/\*)/i, this.startRegionRe =
                /^\s*(\/\*|--)#?region\b/, this.getFoldWidgetRange = function(e, t, n, r) {
                var i = e.getLine(n);
                if (this.startRegionRe.test(i)) return this.getCommentRegionBlock(e, i, n);
                var s = i.match(this.foldingStartMarker);
                if (s) {
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sqlserver_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i), function() {
            this.lineCommentStart = "--", this.blockComment = { start: "/*", end: "*/" }, this.getCompletions =
                function(e, t, n, r) { return t.$mode.$highlightRules.completions }, this.$id = "ace/mode/sql"
        }.call(u.prototype), t.Mode = u
    });
(function() {
    window.require(["ace/mode/sqlserver"],
        function(m) {
