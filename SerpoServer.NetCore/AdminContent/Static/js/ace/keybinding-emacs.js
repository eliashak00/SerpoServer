define("ace/occur",
    ...
    function(e, t, n) {
        ...
        t.iSearchStartCommands = [
            ...
            }, { name: "extendSearchTerm", exec: function(e, t) { e.addString(t) } },
            { name: "extendSearchTermSpace", bindKey: "space", exec: function(e) { e.addString(" ") } },
            { name: "shrinkSearchTerm", bindKey: "backspace", exec: function(e) { e.removeChar() } },
            { name: "confirmSearch", bindKey: "return", exec: function(e) { e.deactivate() } },
            { name: "cancelSearch", bindKey: "esc|Ctrl-G", exec: function(e) { e.deactivate(!0) } }, {
                name: "occurisearch",
                bindKey: "Ctrl-O",
                exec: function(e) {
    ...
    function(e, t, n) {
        ...
        t.handler.attach = function(e) {
            o ||
                (o = !0, r.importCssString(
                    ...
                    "emacsMode")), u = e.session.$selectLongWords, e.session.$selectLongWords = !0, a =
                ...
                }, e.on("click", l), e.on("changeSession", f), e.renderer.$blockCursor =
                    !0, e.setStyle("emacs-mode"), e.commands.addCommands(d), t.handler.platform =
            ...
            e.renderer.$blockCursor = !1, e.session.$selectLongWords = u, e.session.$useEmacsStyleLineStart =
                    a, e.removeEventListener("click", l), e.removeEventListener("changeSession", f),
                e.unsetStyle("emacs-mode"), e.commands.removeCommands(d), e.removeEventListener("copy", this.onCopy),
                e.removeEventListener("paste", this.onPaste), e.$emacsModeHandler = null
        };
        var f = function(e) {
                e.oldSession && (e.oldSession.$selectLongWords = u, e.oldSession.$useEmacsStyleLineStart = a), u =
                        e.session.$selectLongWords, e.session.$selectLongWords = !0, a =
            ...
            l = function(e) { e.editor.session.$emacsMark = null },
        ...
        p.forEach(function(e) {
            var t = 0;
            e.split("-").forEach(function(e) { t |= c[h[e]] }), h[t] = e.toLowerCase() + "-"
        ...
        }, t.emacsKeys =
        {
            ...
            killLine: function(e) {
                ...
                i && n.end.row != i.end.row && (n.end.row = i.end.row, r = "x"), /^\s*$/.test(r) &&
                    (n.end.row++, r = e.session.getLine(n.end.row), n.end.column = /^\s*$/.test(r) ? r.length : 0);
                var s = e.session.getTextRange(n);
                e.prevOp.command == this ? t.killRing.append(s) : t.killRing.add(s), e.session.remove(n), e
                    .clearSelection()
            },
...
(function() {
    window.require(["ace/keyboard/emacs"],
        function(m) {
