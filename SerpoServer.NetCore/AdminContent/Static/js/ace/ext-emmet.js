define("ace/snippets",
    ...
    [
        ...
        "resources", "resources", "tabStops", "resources", "utils", "actions", "ace/config", "ace/config"
    ],
    function(e, t, n) {
        "use strict";
        ...
        f.prototype = {
            ...
            getProfileName: function() {
                ...
                case"html":
                    ...
                    return t ||
                    (t = this.ace.session.getLines(0, 2).join("").search(/<!DOCTYPE[^>]+XHTML/i) != -1
                        ? "xhtml"
                        : "html"), t;
                default:
        ...
        var p = function(e, n) {
            ...
            d = function(t) {
                typeof a == "string" && e("ace/config").loadModule(a, function() { a = null, t && t() })
            };
        t.AceEmmetEditor =
